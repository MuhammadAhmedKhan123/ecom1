...
export default function SlugPage({params}:{params:{Slug:string}}) {
    ...
    const productCat= Object.values(products).filter((val)=>val.slug==params.Slug)
    
     console.log(params.Slug)

  return ( 
      <section className="text-gray-600 body-font overflow-hidden">
 { Object.values(productCat).map((slugCat,i)=>(
  <div key={i} className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <Image
        ...
        src={urlForImage(slugCat.image).url()}
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex">
          ...
          <button onClick={()=>dispatch(addToCart(slugCat._id))} className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">
            Add to Cart
          </button>
